  ...
  <div class="border-t border-gray-200">
    <dl>
      ...
      <div className='relative m-2 flex row justify-center'>
            <p  ><button  type='button' className=" block w-24 bg-blue-600 hover:bg-blue-400  py-2 rounded-2xl text-white font-semibold m-2">retour</button>
            </p>
